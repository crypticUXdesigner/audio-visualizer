...
export const TIMING = {
  ...
  // Double requestAnimationFrame delay (frames)
  RAF_DOUBLE_DELAY: 2,
  
  // Small UI delay in milliseconds
  UI_SMALL_DELAY: 100,
  
  // Control animation delay in milliseconds
  CONTROL_ANIMATION_DELAY: 100,
} as const;
...
export const VALIDATION = {
  ...
  // Minimum volume value (0-1)
  MIN_VOLUME: 0,
  
  // Maximum volume value (0-1)
  MAX_VOLUME: 1,
} as const;
