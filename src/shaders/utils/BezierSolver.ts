 ...
 * @param x - Input x value (0-1)
 * @param x1 - First control point X coordinate (0-1)
 * @param y1 - First control point Y coordinate (0-1)
 * @param x2 - Second control point X coordinate (0-1)
 * @param y2 - Second control point Y coordinate (0-1)
 * @param epsilon - Precision threshold (default: 0.0001)
 * @param maxIterations - Maximum iterations (default: 20)
 * @returns Corresponding y value (0-1)
 * @example
...
export class BezierSolver {
    static solve(x: number, x1: number, y1: number, x2: number, y2: number, epsilon: number = 0.0001, maxIterations: number = 20): number {
